...
| Skill | 目标 | 状态 |
| --- | --- | --- |
| `noctis` | 按预设或显式 workflow 协调原子 Skill 与父子任务 | 初始版本 |
| `implement` | 按 Task/Subtask 实施功能或集中修复并创建检查点提交 | 初始版本 |
| `code-review` | 对精确提交范围执行独立静态审查和修复复核 | 初始版本 |
| `verify` | 按确认场景执行人工、AI 或辅助式行为验收 | 初始版本 |
